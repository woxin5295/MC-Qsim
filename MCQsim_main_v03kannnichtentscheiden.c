    ...
    {   fTimeYears      += fIntSeisTimeStp;
        ...
        {   /*-------------------------------------------------------------------*/
            ...
            {   
                ...
                /*------------------------------------------------------------------*/
                fTemp1 = fabs(fPostSeisIncrStk);
                fTemp2 = fabs(fPostSeisIncrDip);
                fTemp3 = fabs(fPostSeisIncrNrm);
                
                if (sqrt(fTemp1*fTemp1 +fTemp2*fTemp2 +fTemp3*fTemp3) > fMD_CutStrss)
                {   
